...
namespace WinUsbDemo
{
	...
	/*internal sealed*/ public partial  class WinUsbCommunications
	{
		/// <summary>
		...
		/*internal*/ public class SafeWinUsbHandle : SafeHandleZeroOrMinusOneIsInvalid
		{
		...
		/*internal*/ public class DeviceInfo
		{
		...
		internal static void DisplayException(String name, Exception e)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "77777\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		internal Boolean DoControlReadTransfer(SafeWinUsbHandle winUsbHandle, ref Byte[] dataStage)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "88888\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		internal Boolean DoControlWriteTransfer(SafeWinUsbHandle winUsbHandle, Byte[] dataStage)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "99999\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		internal SafeFileHandle GetDeviceHandle(String devicePathName)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "12\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
										  ...
										  UInt32 pipeTimeout)
		{
								...
								for (var i = 0; i <= ifaceDescriptors[interfaceSetting].bNumEndpoints - 1; i++)
								{
									     ...
									     UsbEndpointDirectionIn(pipeInfo[interfaceSetting].PipeId)))
									{
                                        ...
                                        SetPipePolicy
                                            (winUsbHandle,
                                             myDeviceInfo.BulkInPipe,
                                             Convert.ToUInt32(NativeMethods.POLICY_TYPE.AUTO_CLEAR_STALL),
                                             Convert.ToByte(false));

                                        SetPipePolicy
                                            (winUsbHandle,
                                             myDeviceInfo.BulkInPipe,
                                             Convert.ToUInt32(NativeMethods.POLICY_TYPE.RAW_IO),
                                             Convert.ToByte(true));
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "13\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		internal static Boolean QueryDeviceSpeed(SafeWinUsbHandle winUsbHandle, ref DeviceInfo myDevInfo)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "14\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
												 ...
												 ref Byte[] dataBuffer, ref UInt32 bytesRead, ref Boolean success)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "15\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
			//	DisplayException(ModuleName, ex);
			//	throw;
			}
		}
														 ...
														 ref Byte[] dataBuffer, ref UInt32 bytesRead)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "16\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
			//	DisplayException(ModuleName, ex);
				throw;
			}
		}
														 ...
														 ref Byte[] dataInBuffer, ref UInt32 bytesRead, UInt32 numberOfPackets)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "17\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
											  ...
											  Byte[] dataBuffer, ref UInt32 bytesWritten, ref Boolean success)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "18\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				DisplayException(ModuleName, ex);
				throw;
			}
		}
       ...
       internal void Sendfree_usb(SafeWinUsbHandle winUsbHandle,ref Boolean success)
        {
            try
            {
                var thisLock = new Object();
                ...
                lock (thisLock)
                {
                    ...
                    if (!(winUsbHandle.IsInvalid) && (winUsbHandle.IsClosed == true))
                    {
                        success = NativeMethods.WinUsb_Free(winUsbHandle);
                        winUsbHandle.Close();
                        winUsbHandle.DangerousRelease();
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "19\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
                DisplayException(ModuleName, ex);
                throw;
            }
        }

        internal void Sendreset_pipe(SafeWinUsbHandle winUsbHandle,Byte pipeid,ref Boolean success)
        {
            try
            {
                var thisLock = new Object();
                ...
                lock (thisLock)
                {
                    ...
                    if (!(winUsbHandle.IsInvalid))
                    {
                        success = NativeMethods.WinUsb_ResetPipe(winUsbHandle,pipeid);
                    }
                    if (!success)
                    {
                        System.Console.WriteLine(Marshal.GetLastWin32Error());
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "20\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
                DisplayException(ModuleName, ex);
                throw;
            }
        }
													  ...
													  Byte[] dataBuffer, ref UInt32 bytesWritten)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "30\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				//DisplayException(ModuleName, ex);
				throw;
			}
		}
													  ...
													  Byte[] dataOutBuffer, ref UInt32 bytesWritten)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "31\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
			//	DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		///  </returns>
		///  
		public Boolean SetPipePolicy(SafeWinUsbHandle winUsbHandle, Byte pipeId, UInt32 policyType, Byte value)
		{
			try
			{
				var success = false;
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "32\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				//DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		private Boolean SetPipePolicy(SafeWinUsbHandle winUsbHandle, Byte pipeId, UInt32 policyType, UInt32 value)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "34\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				//DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		private Boolean UsbEndpointDirectionIn(Int32 endpointAddress)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "35\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
			//	DisplayException(ModuleName, ex);
				throw;
			}
		}
		...
		private Boolean UsbEndpointDirectionOut(Int32 addr)
		{
            ...
            {
                LogFile.WriteToLogFile(ex.Message + "36\n", AppDomain.CurrentDomain.BaseDirectory, "Exception.txt");
				//DisplayException(ModuleName, ex);
				throw;
			}
		}
        ...
        //internal void Sendreset_pipe(SafeWinUsbHandle port, byte p, bool success)
        //{
