...
namespace WinUsbDemo
{
	...
	/*internal sealed*/ public partial class WinUsbCommunications
	{
		internal static class NativeMethods
		{
            ...
            [DllImport("winusb.dll", SetLastError = true)]
            internal static extern Boolean WinUsb_ResetPipe(SafeWinUsbHandle InterfaceHandle, Byte PipeID);

            [DllImport("winusb.dll", SetLastError = true)]
            internal static extern Boolean WinUsb_Free(SafeWinUsbHandle InterfaceHandle); 
		}
	}
}
